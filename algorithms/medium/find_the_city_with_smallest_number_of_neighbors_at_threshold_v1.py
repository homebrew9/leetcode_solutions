...
# NeetCodeIO - very good explanation!
# ===================================================
        ...
        def dijkstra(n):
            ...
            while h:
                ...
                if node in visited:
                    continue
                visited.add(node)
                for nei, dist2 in hsh[node]:
                    nei_dist = dist + dist2
                    if nei_dist <= distanceThreshold:
                        heapq.heappush(h, (nei_dist, nei))
            #print(f'\tn, visited = {n}, {visited}')
            #print('====')
